...
/**
 * Reranks a graph according to a edge graph metric which we want to worsen.
...
public class OriginalInverseEdgeMetricReranker<U> extends EdgeMetricReranker<U> 
{
    ...
    /**
     * A map containing the values of the edge metric for each pair of nodes.
     */
     ...
     */
    public OriginalInverseEdgeMetricReranker(double lambda, int cutoff, boolean norm, boolean rank, Graph<U> graph, PairMetric<U> graphMetric) 
    {
