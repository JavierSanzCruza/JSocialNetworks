 ...
 */
public class SemiCompleteCommunityEdgeGiniReranker<U> extends CommunityReranker<U> 
{
     ...
     */
    public SemiCompleteCommunityEdgeGiniReranker(double lambda, int cutoff, boolean norm, boolean rank, Graph<U> graph, Communities<U> communities, boolean autoloops) 
    {
    ...
    protected double novAddDelete(U u, Tuple2od<U> itemValue, Tuple2od<U> compared) 
    {
        ...
        double giniValue = 1.0 - gini.compute(stream.boxed(), true, numPairs, this.sum);
        return giniValue;
    }
