 ...
 */
public class TwitterCentroidCosineSimilarityRecommender<U> extends TwitterRecommender<U> 
{
     ...
     */
    public TwitterCentroidCosineSimilarityRecommender(FastGraph<U> graph, int circlesize, double r) {
    ...
    public Int2DoubleMap getScoresMap(int uIdx) 
    {
        ...
        BipartiteRecommender<U> rec = new CentroidCosineSimilarityRecommender(graph);
