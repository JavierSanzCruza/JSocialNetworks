 ...
 */
public class SaltonDocumentBasedRecommender<U> extends CommonNeighborsDocBasedRecommender<U> 
{
/**
     ...
     */
    public SaltonDocumentBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel) 
    {
    ...
    {
        double den = Math.sqrt(vSizes.get(vidx)*uSizes.get(uidx));
        if(den != 0.0) 
            return score/(den);
        return 0.0;
    }
