 ...
 */
package es.uam.eps.ir.socialnetwork.recommendation.mf;

import cern.colt.matrix.DoubleMatrix1D;
import cern.colt.matrix.impl.DenseDoubleMatrix2D;
import org.ranksys.core.preference.fast.FastPreferenceData;
import org.ranksys.core.preference.fast.TransposedPreferenceData;
import org.ranksys.recommenders.mf.als.ALSFactorizer;
...
public class PMFFactorizerSigmoid<U,I> extends ALSFactorizer<U,I>
{
     ...
     */
    private final int numItersGradient = 10;
    /**
     * Constructor.
    ...
    {
        set_min(p,q,lambdaU, data);
    }

    @Override
    protected void set_minQ(DenseDoubleMatrix2D p, DenseDoubleMatrix2D q, FastPreferenceData<U,I> data)
    {
        set_min(q,p,lambdaV, new TransposedPreferenceData<>((FastPreferenceData<I, U>) data));
    }
     ...
     */
    protected void set_min(DenseDoubleMatrix2D p, final DenseDoubleMatrix2D q, double lambda, FastPreferenceData<U,I> data)
    {
        final int K = q.columns();
        // Applying gradient descent for optimizing the P matrix
        for(int i = 0; i < this.numItersGradient; ++i)
        {
