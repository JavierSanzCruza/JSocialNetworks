 ...
 */
public class NonReciprocalPreferentialAttachmentRecommender<U> extends UserFastRankingRecommender<U> 
{
    /**
     ...
     */
    public NonReciprocalPreferentialAttachmentRecommender(FastGraph<U> graph, EdgeOrientation vSel) 
    {
        super(graph);
        this.vSel = vSel;
