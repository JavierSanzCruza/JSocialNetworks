 ...
 */
public class JaccardDocumentBasedRecommender<U> extends CommonNeighborsDocBasedRecommender<U> 
{
    /**
     ...
     */
    public JaccardDocumentBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel) 
    {
    ...
    {
        double den = uSizes.get(uidx) + vSizes.get(vidx) - score;
