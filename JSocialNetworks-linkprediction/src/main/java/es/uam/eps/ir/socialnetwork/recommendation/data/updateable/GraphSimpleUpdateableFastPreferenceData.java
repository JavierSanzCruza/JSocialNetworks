 ...
 */
package es.uam.eps.ir.socialnetwork.recommendation.data.updateable;
...
import es.uam.eps.ir.socialnetwork.recommendation.FastUpdateableGraphIndex;
...
import org.ranksys.core.preferences.fast.updateable.StreamsAbstractFastUpdateablePreferenceData;
...
public class GraphSimpleUpdateableFastPreferenceData<U> extends StreamsAbstractFastUpdateablePreferenceData<U, U> implements FastUpdateablePointWisePreferenceData<U, U>, Serializable
{
            ...
            Function<IdxPref, IdPref<U>> uPrefFun, Function<IdxPref, IdPref<U>> iPrefFun) 
    {
        ...
        this.numPreferences = new Long(fastGraph.getEdgeCount()).intValue();
            ...
            boolean directed, boolean weighted) 
    {
        try 
        {
            ...
            uIndex.getAllUidx().forEach(i ->
            {
                graph.addNode(uIndex.uidx2user(i));
            });
