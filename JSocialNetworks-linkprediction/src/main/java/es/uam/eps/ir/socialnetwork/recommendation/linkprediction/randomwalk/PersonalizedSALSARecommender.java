 ...
 */
public class PersonalizedSALSARecommender<U> extends BipartiteRecommender<U>
{
     ...
     */
    public PersonalizedSALSARecommender(FastGraph<U> graph, boolean mode, double alpha) 
    {
        super(graph, mode);
        this.alpha = alpha;
