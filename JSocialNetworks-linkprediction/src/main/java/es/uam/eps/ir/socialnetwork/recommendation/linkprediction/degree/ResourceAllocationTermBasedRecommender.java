 ...
 */
public class ResourceAllocationTermBasedRecommender<U> extends UserFastRankingRecommender<U> 
{
    /**
     ...
     */
    public ResourceAllocationTermBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel, EdgeOrientation wSel) 
    {
        super(graph);
