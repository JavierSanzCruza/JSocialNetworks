 ...
 */
public class SorensenTermBasedRecommender<U> extends UserFastRankingRecommender<U> 
{
/**
     ...
     */
    public SorensenTermBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel) 
    {
        super(graph);
        this.uSel = uSel;
