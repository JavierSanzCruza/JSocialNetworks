 ...
 */
public class ExtremeBM25DocumentBasedRecommender<U> extends BM25DocumentBasedRecommender<U>
{
    /**
     * Constructor
     * @param graph Graph
     ...
     */
    public ExtremeBM25DocumentBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel, EdgeOrientation dlSel, double b) 
    {
