 ...
 */
public class QLLTermBasedRecommender<U> extends UserFastRankingRecommender<U> 
{
    /**
     ...
     */
    public QLLTermBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel, double gamma) 
    {
        super(graph);
        this.uSel = uSel;
