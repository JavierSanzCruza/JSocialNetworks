...
public class ProgressiveInverseUserMetricReranker<U> extends UserMetricReranker<U> 
{
     ...
     * @param graphMetric The graph metric to minimize.
     * @param rank Indicates if the normalization is by ranking (true) or by score (false)
     */
    public ProgressiveInverseUserMetricReranker(double lambda, int cutoff, boolean norm, boolean rank, Graph<U> graph, VertexMetric<U> graphMetric) 
    {
