 ...
 */
public class ResourceAllocationDocumentBasedRecommender<U> extends CommonNeighborsDocBasedRecommender<U> 
{
    /**
     ...
     */
    public ResourceAllocationDocumentBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel, EdgeOrientation wSel) 
    {
    ...
    protected double getValue(int uidx, int vidx, int widx, double uW, double vW) 
    {
        ...
        return 1.0/(wSizes.get(widx) + 2.0);
    }
