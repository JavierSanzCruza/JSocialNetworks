 ...
 */
package es.uam.eps.ir.socialnetwork.recommendation.reranking.global.graph;
 ...
 */
public class GlobalInverseGraphMetricReranker<U> extends GlobalGraphMetricReranker<U> 
{

    public GlobalInverseGraphMetricReranker(double lambda, int cutoff, boolean norm, Graph<U> graph, GraphMetric<U> graphMetric) 
    {
