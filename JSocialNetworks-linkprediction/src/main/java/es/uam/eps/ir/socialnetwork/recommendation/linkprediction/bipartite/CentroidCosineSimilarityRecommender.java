 ...
 */
public class CentroidCosineSimilarityRecommender<U> extends BipartiteRecommender<U> 
{
     ...
     */
    public CentroidCosineSimilarityRecommender(FastGraph<U> graph) 
    {
        super(graph, true);
