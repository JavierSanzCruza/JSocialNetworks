 ...
 */
public class GlobalDirectEdgeMetricReranker<U> extends GlobalEdgeMetricReranker<U> 
{

    public GlobalDirectEdgeMetricReranker(double lambda, int cutoff, boolean norm, Graph<U> graph, PairMetric<U> graphMetric) 
    {
