...
/**
 * Recommender that uses the HDI coefficient of the neighbours.
 * 
 * @author Javier Sanz-Cruzado Puig
 * @param <U> type of the users.
 */
public class HubDepressedIndexTermBasedRecommender<U> extends UserFastRankingRecommender<U> 
{
    /**
     ...
     */
    public HubDepressedIndexTermBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel) 
    {
        super(graph);
        this.uSel = uSel;
    ...
    public Int2DoubleMap getScoresMap(int uidx) 
    {
        ...
        scoresMap.replaceAll((vidx, sim) -> sim/(Math.max(this.vSizes.get((int) vidx), this.uSizes.get(uidx))));
        return scoresMap;
    }
}
