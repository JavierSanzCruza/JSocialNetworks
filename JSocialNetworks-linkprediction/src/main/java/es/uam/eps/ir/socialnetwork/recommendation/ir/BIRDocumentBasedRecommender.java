 ...
 */
public class BIRDocumentBasedRecommender<U> extends BM25DocumentBasedRecommender<U>
{
    /**
     * Constructor
     * @param graph Graph
     ...
     */
    public BIRDocumentBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel) 
    {
