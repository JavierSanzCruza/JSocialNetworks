 ...
 */
public class LocalLHNIndexTermBasedRecommender<U> extends UserFastRankingRecommender<U> 
{
    /**
     ...
     */
    public LocalLHNIndexTermBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel) 
    {
        super(graph);
        this.uSel = uSel;
