 ...
 */
public class TwitterMaximumCosineSimilarityRecommender<U> extends TwitterRecommender<U> 
{
     ...
     */
    public TwitterMaximumCosineSimilarityRecommender(FastGraph<U> graph, int circlesize, double r) {
    ...
    public Int2DoubleMap getScoresMap(int uIdx) 
    {
        ...
        BipartiteRecommender<U> rec = new MaximumCosineSimilarityRecommender(graph);
