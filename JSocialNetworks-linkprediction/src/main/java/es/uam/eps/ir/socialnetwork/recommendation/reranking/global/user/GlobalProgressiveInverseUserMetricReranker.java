 ...
 * The inverse value of the metric (updated every time a new graph is added) is taken as the novelty score.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users
 */
public class GlobalProgressiveInverseUserMetricReranker<U> extends GlobalUserMetricReranker<U> 
{
    /**
     * Constructor
     ...
     */
    public GlobalProgressiveInverseUserMetricReranker(double lambda, int cutoff, boolean norm, Graph<U> graph, VertexMetric<U> vertexMetric) 
    {
