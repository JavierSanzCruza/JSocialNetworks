 ...
 */
public class BIRTermBasedRecommender<U> extends BM25TermBasedRecommender<U>
{
    /**
     * Constructor
     * @param graph Graph
     ...
     */
    public BIRTermBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel) 
    {
