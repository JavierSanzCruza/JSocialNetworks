 ...
 */
public class TwitterAverageCosineSimilarityRecommender<U> extends TwitterRecommender<U> 
{
     ...
     */
    public TwitterAverageCosineSimilarityRecommender(FastGraph<U> graph, int circlesize, double r) {
    ...
    public Int2DoubleMap getScoresMap(int uIdx) 
    {
        ...
        BipartiteRecommender<U> rec = new AverageCosineSimilarityRecommender(graph);
