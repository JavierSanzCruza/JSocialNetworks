 ...
 */
public class CompleteCommunityOuterDegreeGiniReranker<U> extends CompleteCommunityDegreeGiniReranker<U>
{
    /**
     * Constructor.
     ...
     */
    public CompleteCommunityOuterDegreeGiniReranker(double lambda, int cutoff, boolean norm, boolean rank, Graph<U> graph, Communities<U> communities, boolean autoloops, EdgeOrientation orientation) 
    {
