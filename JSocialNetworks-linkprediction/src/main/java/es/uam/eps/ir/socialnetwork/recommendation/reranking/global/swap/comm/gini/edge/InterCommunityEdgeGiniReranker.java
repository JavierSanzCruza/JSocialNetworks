 ...
 */
public class InterCommunityEdgeGiniReranker<U> extends CommunityReranker<U> 
{
    /**
     ...
     */
    public InterCommunityEdgeGiniReranker(double lambda, int cutoff, boolean norm, boolean rank, Graph<U> graph, Communities<U> communities) 
    {
    ...
    protected double novAddDelete(U u, Tuple2od<U> itemValue, Tuple2od<U> compared) 
    {
        ...
        double incrNew = userComm.equals(recommComm) ? 0.0 : 1.0;
        double incrOld = userComm.equals(delComm) ? 0.0 : -1.0;
    ...
    protected double novAdd(U u, Tuple2od<U> itemValue, Tuple2od<U> compared)
    {
        ...
        double giniValue = 1.0 - gini.compute(stream.boxed(), true, numPairs, sum + 1.0);
    ...
    protected void innerUpdate(U user, Tuple2od<U> updated, Tuple2od<U> old) 
    {
        ...
        {
            addDel = (userComm.equals(delComm)) ? 0.0 : -1.0;
            addNew = (userComm.equals(recommComm)) ? 0.0 : 1.0;
        }
