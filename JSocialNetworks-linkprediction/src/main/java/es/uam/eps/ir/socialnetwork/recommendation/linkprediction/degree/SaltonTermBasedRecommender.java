...
/**
 * Recommender based on Salton similarity.
 * 
 ...
 */
public class SaltonTermBasedRecommender<U> extends UserFastRankingRecommender<U> 
{
/**
     ...
     */
    public SaltonTermBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel) 
    {
        super(graph);
        this.uSel = uSel;
