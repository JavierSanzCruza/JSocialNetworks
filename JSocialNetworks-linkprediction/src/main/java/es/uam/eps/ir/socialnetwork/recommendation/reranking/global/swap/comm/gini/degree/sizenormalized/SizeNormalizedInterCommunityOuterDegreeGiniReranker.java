 ...
 */
package es.uam.eps.ir.socialnetwork.recommendation.reranking.global.swap.comm.gini.degree.sizenormalized;
 ...
 */
public class SizeNormalizedInterCommunityOuterDegreeGiniReranker<U> extends SizeNormalizedInterCommunityDegreeGiniReranker<U>
{
    /**
     ...
     */
    public SizeNormalizedInterCommunityOuterDegreeGiniReranker(double lambda, int cutoff, boolean norm, boolean rank, Graph<U> graph, Communities<U> communities, EdgeOrientation orientation) 
    {
