 ...
 */
public class QLDTermBasedRecommender<U> extends UserFastRankingRecommender<U> 
{
    /**
     ...
     */
    public QLDTermBasedRecommender(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel, double mu) 
    {
        super(graph);
