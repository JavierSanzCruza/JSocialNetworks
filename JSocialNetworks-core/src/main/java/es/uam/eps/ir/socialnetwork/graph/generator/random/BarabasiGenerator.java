 ...
 */
package es.uam.eps.ir.socialnetwork.graph.generator.random;
...
public class BarabasiGenerator<U> implements GraphGenerator<U>
{
     ...
     * @throws es.uam.eps.ir.socialnetwork.graph.generator.exception.GeneratorNotConfiguredException if the generator is not configured
     * @throws es.uam.eps.ir.socialnetwork.graph.generator.exception.GeneratorBadConfiguredException if the generator is badly configured. In this case,
