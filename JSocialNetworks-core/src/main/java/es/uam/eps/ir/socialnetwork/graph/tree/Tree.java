...
public interface Tree<U> extends DirectedGraph<U>
{
     ...
     */
    public default boolean addChild(U parent, U child)
    {
     ...
     * @return true if the child is correctly added, false if not.
     */
    public default boolean addChild(U parent, U child, double weight)
    {
     ...
     * @return true if the child
     */
    public default boolean isChild(U child, U parent)
    {
     ...
     * @return true if the second node descends from the first, false if not.
     */
    public default boolean isDescendant(U child, U parent)
    {
        return this.isAscendant(parent, child);
    }

    @Override
    public default boolean addNode(U node)
    {
        throw new UnsupportedOperationException("Trees do not allow adding nodes this way");
    }
    
    @Override
    public default boolean addEdge(U nodeA, U nodeB, double weight, int type, boolean insertNodes)
    {
        throw new UnsupportedOperationException("Trees do not allow adding nodes this way");
    }
}
