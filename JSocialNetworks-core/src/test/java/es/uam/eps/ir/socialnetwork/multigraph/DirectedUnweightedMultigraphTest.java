 ...
 */
public class DirectedUnweightedMultigraphTest 
{
    
    public DirectedUnweightedMultigraphTest() 
    {
    }
    ...
    {
        // Build the graph
        DirectedMultiGraph<Integer> dg = new FastDirectedUnweightedMultiGraph<>();
    ...
    public void edgeAddition()
    {
        ...
        assertEquals(1, dg.getNumEdges(2, 1));
    }
