...
public class UndirectedWeightedGraphTest 
{
    ...
    public void test()
    {
        ...
        Graph<String> graph = new FastUndirectedWeightedGraph<>();
        ...
        int numExtraPref = IntStream.range(0, N).map(i -> 
        {
            String u = users.get(i);
            Set<Integer> set = new HashSet<>();
            int auxCount = (int) graph.getNeighbourNodes(u).filter(v -> graph.object2idx(v) >= i).mapToInt(v ->
            {
    ...
    public void edgeAddition()
    {
        ...
        assertEquals(true, dg.containsEdge(3,1));
        assertEquals(true, dg.containsEdge(3,2));
        ...
        assertEquals(false, dg.addEdge(2,1));
        assertEquals(true, dg.containsEdge(2,1));
        assertEquals(5L, dg.getEdgeCount());
        
        assertEquals(true, dg.addEdge(2,2));
    ...
    public void weights()
    {
        ...
        for(Weight<Integer, Double> weight : weights)
        {
            ...
            {
                assertEquals(4.0, (double) weight.getValue(), 0.001);
            }
            else
            {
                assertEquals(5.0, (double) weight.getValue(), 0.001);
            }
        }
    ...
    public void updateWeights()
    {
        ...
        assertEquals(true, dg.updateEdgeWeight(2,3, 6.0));
        assertEquals(true, dg.updateEdgeWeight(2, 1, 3.0));
        ...
        for(Weight<Integer, Double> weight : weights)
        {
            ...
            {
                assertEquals(2.0, (double) weight.getValue(), 0.001);
            }
        }
        ...
        for(Weight<Integer, Double> weight : weights)
        {
            if(weight.getIdx().equals(1))
                ...
                assertEquals(6.0, (double) weight.getValue(), 0.001);
        }
