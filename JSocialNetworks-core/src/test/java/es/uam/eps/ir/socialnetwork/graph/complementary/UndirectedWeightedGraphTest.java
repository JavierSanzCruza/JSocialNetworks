...
import es.uam.eps.ir.socialnetwork.graph.*;
...
public class UndirectedWeightedGraphTest 
{
    ...
    public void nodeAddition()
    {
        ...
        assertEquals(false, compl.containsVertex(4));
        assertEquals(false, compl.containsVertex(0));
        
        // Check existing nodes
        assertEquals(true, compl.containsVertex(1));
        assertEquals(true, compl.containsVertex(2));
        assertEquals(true, compl.containsVertex(3));
    ...
    public void edgeAddition()
    {
        ...
        assertEquals(false, compl.containsEdge(4,5));
        // With an existent node and a non-existent one
        assertEquals(false, compl.containsEdge(3,4));
        assertEquals(false, compl.containsEdge(4,3));
        
        // Check existent nodes
        assertEquals(false, compl.containsEdge(1,2));
        assertEquals(true, compl.containsEdge(1,3));
        assertEquals(false, compl.containsEdge(2,3));
        assertEquals(false, compl.containsEdge(2,1));
        assertEquals(true, compl.containsEdge(3,1));
        assertEquals(false, compl.containsEdge(3,2));
        ...
        assertEquals(false, compl.containsEdge(5, 6));   
        assertEquals(true, compl.containsEdge(3, 6));
        assertEquals(true, compl.containsEdge(6, 3));
