...
import org.ranksys.novdiv.sales.metrics.IUD;

/**
 * Configures a inter-user diversity (IUD) metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 */
public class IUDConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{
    @Override
