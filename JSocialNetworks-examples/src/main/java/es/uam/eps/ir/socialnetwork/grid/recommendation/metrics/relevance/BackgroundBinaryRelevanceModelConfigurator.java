...
/**
 * Configures a Background Binary Relevance Model.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.metrics.rel.BackgroundBinaryRelevanceModel
 */
public class BackgroundBinaryRelevanceModelConfigurator<U,I> implements RelevanceConfigurator<U,I> 
{
    /**
    ...
    /**
     * Identifier for the background gain value.
     */
    ...
    public RelevanceModel<U, I> configure(RelevanceParamReader params, PreferenceData<U, I> trainData, PreferenceData<U, I> testData)
    {
        ...
        double background = params.getParams().getDoubleValue(BACKGROUND);
        
        return new BackgroundBinaryRelevanceModel<>(caching, testData, threshold, background);
    }
