...
import static es.uam.eps.ir.socialnetwork.grid.informationpropagation.filter.FilterIdentifiers.*;
 ...
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.data.filter
 */
