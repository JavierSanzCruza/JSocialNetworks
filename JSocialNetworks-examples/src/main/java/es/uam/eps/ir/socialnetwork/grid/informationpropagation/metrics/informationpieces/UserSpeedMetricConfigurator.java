...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.informationpieces.individual.UserSpeed;
import java.io.Serializable;

/**
 * Configures a Num. Info. metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the information pieces.
 * @param <P> Type of the parameters.
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.metrics.informationpieces.NumInfo
 */
public class UserSpeedMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P> 
{
    @Override
