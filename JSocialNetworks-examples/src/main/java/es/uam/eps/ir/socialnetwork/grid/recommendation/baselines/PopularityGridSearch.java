...
import static es.uam.eps.ir.socialnetwork.grid.recommendation.AlgorithmIdentifiers.POPULARITY;
...
{       
    ...
    public Map<String, BiFunction<FastGraph<U>, FastPreferenceData<U, U>, Recommender<U, U>>> grid(Grid grid) 
    {
        ...
        {
            return new DestinationDegreeRecommender<>(graph, EdgeOrientation.IN);
        };
        
        recs.put(POPULARITY, bifunction);
        return recs;
    }
