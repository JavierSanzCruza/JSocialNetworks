...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.global.ExternalFeatureGlobalGini;
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.global.FeatureGlobalGini;

import java.io.Serializable;

/**
 * Configures a global feature Gini metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the information pieces.
 * @param <P> Type of the parameters.
 * @see FeatureGlobalGini
 */
public class ExternalFeatureGlobalGiniMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P>
{
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new ExternalFeatureGlobalGini<>(parameter, userParam, unique);
    }
