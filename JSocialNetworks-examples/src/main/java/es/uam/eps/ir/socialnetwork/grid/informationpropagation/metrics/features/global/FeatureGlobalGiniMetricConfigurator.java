 ...
 */
public class FeatureGlobalGiniMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P> 
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new FeatureGlobalGini<>(parameter, userParam, unique);
    }
