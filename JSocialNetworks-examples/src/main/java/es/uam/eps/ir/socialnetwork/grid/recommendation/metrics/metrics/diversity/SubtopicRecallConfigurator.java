...
import org.ranksys.novdiv.other.metrics.SRecall;

/**
 * Configures a Subtopic Recall metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * @param <F> Type of the parameters.
 * 
 * @see es.uam.eps.ir.ranksys.diversity.other.metrics.SRecall
 */
public class SubtopicRecallConfigurator<U,I,F> implements RecommendationMetricConfigurator<U,I>
{
    @Override
    public <F> MetricFunction<U, I, F> configure(RecommendationMetricParamReader params)
    {
        ...
        {
            return new AverageRecommendationMetric<>(new SRecall<>(featureData,cutoff, relModel), true);
        };
    }
