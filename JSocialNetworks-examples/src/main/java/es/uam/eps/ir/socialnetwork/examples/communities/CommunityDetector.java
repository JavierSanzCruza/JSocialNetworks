...
import es.uam.eps.ir.socialnetwork.grid.community.CommunityDetectionParamReader;
import es.uam.eps.ir.socialnetwork.grid.community.CommunityDetectionSelector;
