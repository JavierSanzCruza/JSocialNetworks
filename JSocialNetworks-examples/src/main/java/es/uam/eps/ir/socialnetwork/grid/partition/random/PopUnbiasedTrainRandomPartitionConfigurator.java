...
import static es.uam.eps.ir.socialnetwork.grid.partition.PartitionAlgorithmIdentifiers.POPUNBIASEDTRAINRANDOM;
import es.uam.eps.ir.socialnetwork.partition.Partition;
import es.uam.eps.ir.socialnetwork.partition.random.PopUnbiasedTrainRandomPartition;
import es.uam.eps.ir.socialnetwork.utils.datatypes.Tuple2oo;

/**
 * Class for configuring popularity unbiased random partitions, selecting a fixed number
 * of train ratings.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users
 * 
 * @see es.uam.eps.ir.socialnetwork.partition.random.PopUnbiasedTrainRandomPartition
 */
public class PopUnbiasedTrainRandomPartitionConfigurator<U> implements PartitionAlgorithmConfigurator<U> 
{
    /**
    ...
    public Tuple2oo<String, Partition<U>> grid(Parameters params) 
    {
        ...
        return new Tuple2oo<>(POPUNBIASEDTRAINRANDOM, new PopUnbiasedTrainRandomPartition<>(epsilon, percentage));
    }
