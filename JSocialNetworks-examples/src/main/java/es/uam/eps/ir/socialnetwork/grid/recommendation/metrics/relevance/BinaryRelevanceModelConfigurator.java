...
/**
 * Configures a Binary Relevance Model.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.metrics.rel.BinaryRelevanceModel
 */
public class BinaryRelevanceModelConfigurator<U,I> implements RelevanceConfigurator<U,I> 
{
    /**
    ...
    public RelevanceModel<U, I> configure(RelevanceParamReader params, PreferenceData<U, I> trainData, PreferenceData<U, I> testData)
    {
        ...
        return new BinaryRelevanceModel<>(caching, testData, threshold);
    }
