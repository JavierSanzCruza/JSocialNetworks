...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.global.FeatureGlobalKLDivergenceInverse;
import java.io.Serializable;

/**
 * Configures a global inverse Feature KL Divergence metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the information pieces.
 * @param <P> Type of the parameters.
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.global.FeatureGlobalKLDivergenceInverse
 */
public class FeatureGlobalKLDivergenceInverseMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P> 
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new FeatureGlobalKLDivergenceInverse<>(parameter, userParam, unique);
    }
