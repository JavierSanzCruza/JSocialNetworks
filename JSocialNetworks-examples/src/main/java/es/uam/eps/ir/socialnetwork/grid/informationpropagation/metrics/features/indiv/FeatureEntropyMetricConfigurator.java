...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.indiv.FeatureEntropy;
import java.io.Serializable;

/**
 * Configures a feature Entropy metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the information pieces.
 * @param <P> Type of the parameters.
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.indiv.FeatureEntropy
 */
public class FeatureEntropyMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P> 
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new FeatureEntropy<>(parameter, userParam, unique);
    }
