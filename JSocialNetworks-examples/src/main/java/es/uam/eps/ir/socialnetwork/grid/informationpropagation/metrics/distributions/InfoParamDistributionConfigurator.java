...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.distributions.InfoParamDistribution;
 ...
 */
public class InfoParamDistributionConfigurator<U extends Serializable,I extends Serializable,P> implements DistributionConfigurator<U,I,P>
{
    /**
    ...
    public Distribution<U, I, P> configure(DistributionParamReader params) 
    {
        ...
        return new InfoParamDistribution<>(parameter);
    }
