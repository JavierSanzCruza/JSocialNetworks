...
import static es.uam.eps.ir.socialnetwork.grid.metrics.graph.GraphMetricIdentifiers.COMPLETEEDGEGINI;
import es.uam.eps.ir.socialnetwork.metrics.GraphMetric;
import es.uam.eps.ir.socialnetwork.metrics.distance.DistanceCalculator;
import es.uam.eps.ir.socialnetwork.metrics.graph.CompleteEdgeGini;
...
{    
    ...
    public Map<String, Supplier<GraphMetric<U>>> grid(Grid grid, DistanceCalculator<U> distCalc)
    {
        ...
        metrics.put(COMPLETEEDGEGINI, () -> 
        {
            return new CompleteEdgeGini();
        });
    ...
    public Map<String, Function<DistanceCalculator<U>, GraphMetric<U>>> grid(Grid grid)
    {
        ...
        metrics.put(COMPLETEEDGEGINI, (distCalc) -> 
        {
            return new CompleteEdgeGini();
        });
