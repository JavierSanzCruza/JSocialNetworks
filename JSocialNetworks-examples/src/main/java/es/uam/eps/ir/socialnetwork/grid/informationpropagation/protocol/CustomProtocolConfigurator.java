...
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.expiration.ExpirationSelector;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.propagation.PropagationSelector;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.selection.SelectionSelector;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.sight.SightSelector;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.update.UpdateSelector;
...
import es.uam.eps.ir.socialnetwork.informationpropagation.protocols.CustomProtocol;
...
public class CustomProtocolConfigurator<U extends Serializable,I extends Serializable,P> implements ProtocolConfigurator<U,I,P> 
{
    ...
    public Protocol<U, I, P> configure(ProtocolParamReader params) 
    {
        ...
        if(sightPair == null)
            return null;
        SightMechanism sight = sightPair.v2();
