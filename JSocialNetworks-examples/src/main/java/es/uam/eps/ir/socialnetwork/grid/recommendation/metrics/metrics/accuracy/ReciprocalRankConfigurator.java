...
/**
 * Configures a reciprocal rank metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.metrics.basic.ReciprocalRank
 */
public class ReciprocalRankConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{
    @Override
    public <F> MetricFunction<U, I, F> configure(RecommendationMetricParamReader params)
    {
        ...
        {
            return new AverageRecommendationMetric<>(new ReciprocalRank<>(cutoff, relModel), true);
        };
    }
