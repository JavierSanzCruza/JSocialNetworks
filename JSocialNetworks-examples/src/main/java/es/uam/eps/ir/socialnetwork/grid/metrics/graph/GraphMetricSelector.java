...
import static es.uam.eps.ir.socialnetwork.grid.metrics.graph.GraphMetricIdentifiers.*;
...
public class GraphMetricSelector<U>
{
     ...
     */
    public Map<String, Function<DistanceCalculator<U>, GraphMetric<U>>> getMetrics(String name, Grid grid)
    {
        GraphMetricGridSearch<U> gridsearch = this.getGridSearch(name);
