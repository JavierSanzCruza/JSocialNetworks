 ...
 */
public class EILDConfigurator<U,I,F> implements RecommendationMetricConfigurator<U,I>
{
    /**
    ...
    public <F> MetricFunction<U, I, F> configure(RecommendationMetricParamReader params)
    {
        ...
        return (trainData, testData, featureData, relModel, discModel, cutoff)->
        {
            ...
            return new AverageRecommendationMetric<>(new EILD<>(cutoff, distModel, relModel, discModel), true);
        };
    }
