 ...
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.indiv.FeatureRecall
 */
public class FeatureRecallMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P>
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new FeatureRecall<>(parameter, userParam);
    }
