...
import static es.uam.eps.ir.socialnetwork.grid.metrics.pair.PairMetricIdentifiers.DISTANCEWITHOUTLINK;
import es.uam.eps.ir.socialnetwork.metrics.PairMetric;
import es.uam.eps.ir.socialnetwork.metrics.distance.DistanceCalculator;
import es.uam.eps.ir.socialnetwork.metrics.pair.DistanceWithoutLink;
...
public class DistanceWithoutLinkGridSearch<U> implements PairMetricGridSearch<U>
{
    ...
    public Map<String, Supplier<PairMetric<U>>> grid(Grid grid, DistanceCalculator<U> distCalc)
    {
        ...
        map.put(DISTANCEWITHOUTLINK, () -> {
            return new DistanceWithoutLink();
        });
        return map;
    }
    ...
    public Map<String, Function<DistanceCalculator<U>, PairMetric<U>>> grid(Grid grid)
    {
        ...
        map.put(DISTANCEWITHOUTLINK, (distCalc) -> {
            return new DistanceWithoutLink();
        });
        return map;
    }
