...
import org.ranksys.novdiv.sales.metrics.GiniSimpsonIndex;

/**
 * Configures a Gini-Simpson index metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.diversity.sales.metrics.GiniSimpsonIndex
 */
public class GiniSimpsonConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{
    @Override
    ...
    {
        return new GiniSimpsonIndex<>(cutoff);
    }
}
