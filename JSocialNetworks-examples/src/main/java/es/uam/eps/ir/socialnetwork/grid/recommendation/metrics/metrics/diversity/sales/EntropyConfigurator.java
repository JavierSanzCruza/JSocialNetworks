...
import org.ranksys.novdiv.sales.metrics.Entropy;

/**
 * Configures a entropy metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.diversity.sales.metrics.Entropy
 */
public class EntropyConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{
    @Override
