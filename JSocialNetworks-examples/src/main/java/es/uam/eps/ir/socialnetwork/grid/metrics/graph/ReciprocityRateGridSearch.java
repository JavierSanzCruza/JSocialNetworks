...
import static es.uam.eps.ir.socialnetwork.grid.metrics.graph.GraphMetricIdentifiers.RECIPROCITYRATE;
import es.uam.eps.ir.socialnetwork.metrics.GraphMetric;
import es.uam.eps.ir.socialnetwork.metrics.distance.DistanceCalculator;
import es.uam.eps.ir.socialnetwork.metrics.graph.ReciprocityRate;
...
{    
    ...
    public Map<String, Function<DistanceCalculator<U>, GraphMetric<U>>> grid(Grid grid)
    {
        ...
        metrics.put(RECIPROCITYRATE, (distCalc) -> 
        {
            return new ReciprocityRate();
        });
