...
/**
 * Configures a precision metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.metrics.basic.Precision
 */
public class PrecisionConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{
    @Override
    public <F> MetricFunction<U, I, F> configure(RecommendationMetricParamReader params)
    {
        ...
        {
            return new AverageRecommendationMetric<>(new Precision<>(cutoff, relModel), true);
        };
    }
