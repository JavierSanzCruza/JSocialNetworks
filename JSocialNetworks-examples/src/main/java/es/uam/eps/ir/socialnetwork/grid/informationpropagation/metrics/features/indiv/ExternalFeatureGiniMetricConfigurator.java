...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.indiv.ExternalFeatureGini;
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.indiv.FeatureGini;

import java.io.Serializable;

/**
 * Configures a feature Gini metric.
 ...
 * @see FeatureGini
 */
public class ExternalFeatureGiniMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P>
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new ExternalFeatureGini<>(parameter, userParam, unique);
    }
