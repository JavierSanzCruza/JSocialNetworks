...
/**
 * Configures a recall metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.metrics.basic.Recall
 */
public class RecallConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{
    /**
    ...
    public <F> MetricFunction<U, I, F> configure(RecommendationMetricParamReader params)
    {
        ...
        return (trainData, testData, featureData, relModel, discModel, cutoff) -> 
        {
            ...
            return new AverageRecommendationMetric<>(new Recall<>(cutoff, idealModel), true);
        };
    }
