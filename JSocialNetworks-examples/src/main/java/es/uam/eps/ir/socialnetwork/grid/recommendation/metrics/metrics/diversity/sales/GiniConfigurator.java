...
/**
 * Configures a Gini index metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.diversity.sales.metrics.GiniIndex

 */
public class GiniConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{
    @Override
    ...
    {
        return new GiniIndex<>(cutoff, trainData.numItems());
    }
}
