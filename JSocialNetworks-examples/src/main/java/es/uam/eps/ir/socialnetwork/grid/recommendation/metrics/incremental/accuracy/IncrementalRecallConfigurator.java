...
import org.ranksys.metrics.incremental.IncrementalRecall;
import org.ranksys.metrics.incremental.system.AverageIncrementalMetric;
...
/**
 * Configures an incremental recall metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see org.ranksys.metrics.incremental.IncrementalRecall
 */
public class IncrementalRecallConfigurator<U,I> implements IncrementalRecommendationMetricConfigurator<U,I>
{
    /**
    ...
    public <F> IncrementalMetricFunction<U, I, F> configure(IncrementalRecommendationMetricParamReader params)
    {
        ...
        return (trainData, testData, relModel, discModel, cutoff) -> 
        {
            ...
            return new AverageIncrementalMetric<>(new IncrementalRecall<>(cutoff, idealModel, removeExt));
        };
    }
