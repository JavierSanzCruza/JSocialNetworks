...
/**
 * Configures a relevance model for nDCG metrics
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.metrics.basic.NDCG.NDCGRelevanceModel
 * 
 */
public class NDCGRelevanceModelConfigurator<U,I> implements RelevanceConfigurator<U,I> 
{
    /**
    ...
    public RelevanceModelFunction<U, I> configure(RelevanceParamReader params) 
    {
        ...
        {
            return new NDCG.NDCGRelevanceModel<>(caching, testData, threshold);
        };
    }
