...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.indiv.ExternalFeatureRate;
import java.io.Serializable;

/**
 * Configures a external feature rate metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the information pieces.
 * @param <P> Type of the parameters.
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.indiv.ExternalFeatureRate
 */
public class ExternalFeatureRateMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P> 
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new ExternalFeatureRate<>(parameter, userParam, unique);
    }
