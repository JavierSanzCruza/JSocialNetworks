...
import es.uam.eps.ir.socialnetwork.graph.generator.random.ErdosGenerator;
 ...
 */
public class ErdosGraphGenerator 
{
    /**
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // Generating
        ErdosGenerator<Long> gg = new ErdosGenerator<>();
        gg.configure(directed, numNodes, p, Generators.longgen);
