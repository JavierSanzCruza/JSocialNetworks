...
import es.uam.eps.ir.socialnetwork.informationpropagation.data.filter.EmptyFeatureFilter;
 ...
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.data.filter.BasicFilter
 */
