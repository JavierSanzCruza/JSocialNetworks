...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.global.FeatureGlobalKLDivergence;
 ...
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.global.FeatureGlobalKLDivergence
 */
public class FeatureGlobalKLDivergenceMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P> 
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new FeatureGlobalKLDivergence<>(parameter, userParam, unique);
    }
