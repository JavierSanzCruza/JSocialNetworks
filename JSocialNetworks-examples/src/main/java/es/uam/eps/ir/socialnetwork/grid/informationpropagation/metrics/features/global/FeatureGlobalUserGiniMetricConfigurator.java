...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.features.global.FeatureGlobalUserGini;
 ...
 */
public class FeatureGlobalUserGiniMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P> 
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new FeatureGlobalUserGini<>(parameter, userParam);
    }
