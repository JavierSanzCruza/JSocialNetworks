...
import static es.uam.eps.ir.socialnetwork.grid.partition.PartitionAlgorithmIdentifiers.POPUNBIASEDTESTWEIGHTS;
import es.uam.eps.ir.socialnetwork.partition.Partition;
import es.uam.eps.ir.socialnetwork.partition.weights.PopUnbiasedTestWeightsPartition;
import es.uam.eps.ir.socialnetwork.utils.datatypes.Tuple2oo;

/**
 * Class for configuring popularity unbiased partitions, selecting a fixed number
 * of test ratings (the ones with smaller weight).
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users
 * 
 * @see es.uam.eps.ir.socialnetwork.partition.weights.PopUnbiasedTestWeightsPartition
 */
public class PopUnbiasedTestWeightsPartitionConfigurator<U> implements PartitionAlgorithmConfigurator<U> 
{
    /**
    ...
    public Tuple2oo<String, Partition<U>> grid(Parameters params) 
    {
        ...
        return new Tuple2oo<>(POPUNBIASEDTESTWEIGHTS, new PopUnbiasedTestWeightsPartition<>(epsilon, percentage));
    }
