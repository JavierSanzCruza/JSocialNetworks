...
import static es.uam.eps.ir.socialnetwork.grid.metrics.vertex.VertexMetricIdentifiers.ECCENTRICITY;
...
{    
    ...
    public Map<String, Supplier<VertexMetric<U>>> grid(Grid grid, DistanceCalculator<U> distCalc)
    {
        ...
        metrics.put(ECCENTRICITY, () -> 
        {
            return new Eccentricity(distCalc);
        });
    ...
    public Map<String, Function<DistanceCalculator<U>, VertexMetric<U>>> grid(Grid grid)
    {
        ...
        metrics.put(ECCENTRICITY, (distCalc) -> 
        {
            return new Eccentricity(distCalc);
        });
