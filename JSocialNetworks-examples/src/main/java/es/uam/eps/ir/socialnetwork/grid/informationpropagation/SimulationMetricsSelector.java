 ...
 */
package es.uam.eps.ir.socialnetwork.grid.informationpropagation;

import es.uam.eps.ir.socialnetwork.graph.Graph;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.filter.FilterParamReader;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.filter.FilterSelector;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.metrics.MetricParamReader;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.metrics.MetricSelector;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.metrics.distributions.DistributionParamReader;
import es.uam.eps.ir.socialnetwork.grid.informationpropagation.metrics.distributions.DistributionSelector;
import es.uam.eps.ir.socialnetwork.informationpropagation.data.filter.CombinedFilter;
