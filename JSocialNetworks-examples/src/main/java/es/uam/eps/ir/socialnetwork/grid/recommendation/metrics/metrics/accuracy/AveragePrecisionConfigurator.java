...
import org.ranksys.metrics.basic.AveragePrecision;
...
/**
 * Configures an average precision metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.metrics.basic.AveragePrecision
 */
public class AveragePrecisionConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{   
    /**
    ...
    public <F> MetricFunction<U, I, F> configure(RecommendationMetricParamReader params)
    {
        ...
        return (trainData, testData, featureData, relModel, discModel, cutoff) -> 
        {
            ...
            return new AverageRecommendationMetric<>(new AveragePrecision<>(cutoff, idealModel), true);
        };
    }
