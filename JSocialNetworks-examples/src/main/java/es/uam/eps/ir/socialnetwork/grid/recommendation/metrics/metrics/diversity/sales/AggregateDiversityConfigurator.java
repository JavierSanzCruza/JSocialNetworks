...
/**
 * Configures an aggregate diversity metric.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the items.
 * 
 * @see es.uam.eps.ir.ranksys.diversity.sales.metrics.AggregateDiversityMetric
 */
public class AggregateDiversityConfigurator<U,I> implements RecommendationMetricConfigurator<U,I>
{
    @Override
    public <F> MetricFunction<U, I, F> configure(RecommendationMetricParamReader params)
    {
        ...
        {
            return new AggregateDiversityMetric<>(cutoff, relModel);
        };
    }
