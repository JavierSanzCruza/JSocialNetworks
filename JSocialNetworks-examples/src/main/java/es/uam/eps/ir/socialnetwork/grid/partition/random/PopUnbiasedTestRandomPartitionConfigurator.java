...
import static es.uam.eps.ir.socialnetwork.grid.partition.PartitionAlgorithmIdentifiers.POPUNBIASEDTESTRANDOM;
import es.uam.eps.ir.socialnetwork.partition.Partition;
import es.uam.eps.ir.socialnetwork.partition.random.PopUnbiasedTestRandomPartition;
 ...
 * 
 * @see es.uam.eps.ir.socialnetwork.partition.random.PopUnbiasedTestRandomPartition
 */
public class PopUnbiasedTestRandomPartitionConfigurator<U> implements PartitionAlgorithmConfigurator<U> 
{
    /**
    ...
    public Tuple2oo<String, Partition<U>> grid(Parameters params) 
    {
        ...
        return new Tuple2oo<>(POPUNBIASEDTESTRANDOM, new PopUnbiasedTestRandomPartition<>(epsilon, percentage));
    }
