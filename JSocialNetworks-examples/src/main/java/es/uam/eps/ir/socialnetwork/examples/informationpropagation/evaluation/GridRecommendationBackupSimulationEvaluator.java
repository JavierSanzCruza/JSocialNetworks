 ...
 */
public class GridRecommendationBackupSimulationEvaluator 
{
    /**
    ...
    public static void main(String[] args) throws IOException
    {
        if(args.length < 18)
        {
            ...
            System.err.println("\tbackup: File containing the backup of a simulation");
            return;
        }
        ...
        for(String file : folder.list())
        {
            ...
            try(BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(outputFolder+outputFile+"-metrics.txt"))))
            {
                ...
                {
                    metric.clear();
                    metric.initialize(filteredData, backupSim);
