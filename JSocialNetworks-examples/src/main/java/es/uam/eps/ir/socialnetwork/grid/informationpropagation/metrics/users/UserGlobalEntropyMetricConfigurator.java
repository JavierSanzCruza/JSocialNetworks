...
import es.uam.eps.ir.socialnetwork.informationpropagation.metrics.user.global.UserGlobalEntropy;
 ...
 */
public class UserGlobalEntropyMetricConfigurator<U extends Serializable,I extends Serializable,P> implements MetricConfigurator<U,I,P> 
{
    /**
    ...
    public SimulationMetric<U, I, P> configure(MetricParamReader params) 
    {
        ...
        return new UserGlobalEntropy<>(unique);
    }
}
