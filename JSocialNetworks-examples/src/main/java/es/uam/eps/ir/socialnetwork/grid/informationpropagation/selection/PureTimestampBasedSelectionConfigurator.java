...
/**
 * Configures a Pure Timestamp-based selection mechanism.
 * @author Javier Sanz-Cruzado Puig
 * @param <U> Type of the users.
 * @param <I> Type of the information pieces.
 * @param <P> Type of the parameters.
 * 
 * @see es.uam.eps.ir.socialnetwork.informationpropagation.selections.PureTimestampBasedSelectionMechanism
 */
