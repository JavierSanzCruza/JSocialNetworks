 ...
 */
public class NodeRootedMetropolisHastingsRandomWalkSampler<U> extends AbstractNodeMetropolisHastingsRandomWalkSampler<U> 
{
    /**
     * Constructor.
     ...
     */
    public NodeRootedMetropolisHastingsRandomWalkSampler(EdgeOrientation orientation, double r, int maxNumIterMultiplier, int numInitial) 
    {
