...
/**
 * Finds a sample of a graph using the method known as Depth-First Search (DFS)
 * 
 ...
 */
public class TraverseDFSSampler<U> extends AbstractTraverseSearchSampler<U> 
{
    /**
     * Constructor.
     * @param orientation The orientation.
     */
    public TraverseDFSSampler(EdgeOrientation orientation) 
    {
        super(orientation, 1);
    }
