 ...
 */
package es.uam.eps.ir.socialnetwork.subsampling.randomwalk.node;
 ...
 * 5. Add the other node to the visited set.
 * 6. Iterate until the desired number of nodes is reached.
 ...
 */
public class NodeFrontierSampler<U> extends AbstractNodeSampler<U> 
{
    /**
     ...
     */
    public NodeFrontierSampler(EdgeOrientation orientation, int numInitial)
    {
