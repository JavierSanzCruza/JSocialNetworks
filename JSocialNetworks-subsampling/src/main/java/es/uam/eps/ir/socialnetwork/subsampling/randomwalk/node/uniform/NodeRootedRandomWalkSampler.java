 ...
 */
public class NodeRootedRandomWalkSampler<U> extends AbstractNodeUniformRandomWalkSampler<U> 
{
    /**
     * Constructor.
     ...
     */
    public NodeRootedRandomWalkSampler(EdgeOrientation orientation, double r, int maxNumIterMultiplier, int numInitial) 
    {
