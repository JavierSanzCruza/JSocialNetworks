 ...
 */
public class NodeRandomWalkJumpSampler<U> extends AbstractNodeUniformRandomWalkSampler<U> 
{
    /**
     * Constructor.
     ...
     */
    public NodeRandomWalkJumpSampler(EdgeOrientation orientation, double r, int maxNumIterMultiplier, int numInitial) 
    {
