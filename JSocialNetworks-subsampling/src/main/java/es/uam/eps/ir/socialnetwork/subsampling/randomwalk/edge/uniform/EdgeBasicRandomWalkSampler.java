 ...
 */
public class EdgeBasicRandomWalkSampler<U> extends EdgeRandomWalkJumpSampler<U> 
{
     ...
     */
    public EdgeBasicRandomWalkSampler(EdgeOrientation orientation, int maxNumIterMultiplier, int numInitial) 
    {
