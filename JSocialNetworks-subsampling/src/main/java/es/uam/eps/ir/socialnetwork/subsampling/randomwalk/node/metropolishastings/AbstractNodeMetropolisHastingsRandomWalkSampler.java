 ...
 */
public abstract class AbstractNodeMetropolisHastingsRandomWalkSampler<U> extends AbstractNodeRandomWalkSampler<U> 
{
     ...
     */
    public AbstractNodeMetropolisHastingsRandomWalkSampler(EdgeOrientation orientation, double r, int maxNumIterMultiplier, int numInitial) 
    {
