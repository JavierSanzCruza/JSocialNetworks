 ...
 * 
 */ 
public class PopUnbiasedTrainRandomPartition<V> extends AbstractPartition<V>
{
    /**
     ...
     */
    public PopUnbiasedTrainRandomPartition(double epsilon, double sigma)
    {
    ...
    public boolean doPartition(Graph<V> graph) 
    {
        try 
        {
            ...
            System.out.println("perc:" + (sigma) + " epsilon:" + epsilon + " zeta: " + zeta + " nu:" + nu);
