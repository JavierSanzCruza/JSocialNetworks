 ...
 */
public class NodeMetropolisHastingsRandomWalkJumpSampler<U> extends AbstractNodeMetropolisHastingsRandomWalkSampler<U> 
{
    /**
     * Constructor.
     ...
     */
    public NodeMetropolisHastingsRandomWalkJumpSampler(EdgeOrientation orientation, double r, int maxNumIterMultiplier, int numInitial) 
    {
