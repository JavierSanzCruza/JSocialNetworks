 ...
 */
public class EdgeRootedMetropolisHastingsRandomWalkSampler<U> extends AbstractEdgeMetropolisHastingsRandomWalkSampler<U> 
{
    /**
     * Constructor.
     ...
     */
    public EdgeRootedMetropolisHastingsRandomWalkSampler(EdgeOrientation orientation, double r, int maxNumIterMultiplier, int numInitial) 
    {
