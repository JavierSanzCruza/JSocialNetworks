 ...
 */
public abstract class AbstractEdgeUniformRandomWalkSampler<U> extends AbstractEdgeRandomWalkSampler<U> 
{
     ...
     */
    public AbstractEdgeUniformRandomWalkSampler(EdgeOrientation orientation, double r, int maxNumIterMultiplier, int numInitial) 
    {
