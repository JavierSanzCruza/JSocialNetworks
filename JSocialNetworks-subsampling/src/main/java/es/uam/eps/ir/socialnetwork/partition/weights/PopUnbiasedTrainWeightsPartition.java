 ...
 * Selects the same number of training ratings for each candidate item.
 * 
 ...
 * 
 */ 
public class PopUnbiasedTrainWeightsPartition<V> extends AbstractPartition<V>
{
    /**
     ...
     */
    public PopUnbiasedTrainWeightsPartition(double epsilon, double sigma)
    {
    ...
    public boolean doPartition(Graph<V> graph) 
    {
        try 
        {
            ...
            System.out.println("perc:" + (sigma) + " epsilon:" + epsilon + " zeta: " + zeta + " nu:" + nu + " max:" + max);
