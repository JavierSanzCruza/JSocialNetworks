...
import es.uam.eps.ir.socialnetwork.metrics.distance.Diameter;
import es.uam.eps.ir.socialnetwork.metrics.distance.Eccentricity;
import es.uam.eps.ir.socialnetwork.metrics.distance.EdgeBetweenness;
import es.uam.eps.ir.socialnetwork.metrics.distance.Geodesics;
...
public class BetweennessMetricsTest {
    ...
    public void geodesics()
    {
        ...
        Assert.assertEquals(0.333333, geod.averageValue(this.directedEmpty), 0.0001);
                
        geod = new Geodesics<>(ueBetweennessCalculator);
        Assert.assertEquals(0.333333, geod.averageValue(this.undirectedEmpty), 0.0001);
        ...
        Assert.assertEquals(0.5306122, geod.averageValue(this.directedWeaklyConnected),0.0001);
        
        geod = new Geodesics<>(dscBetweennessCalculator);
        Assert.assertEquals(1.183673, geod.averageValue(this.directedStronglyConnected), 0.0001);      
        
        geod = new Geodesics<>(dncBetweennessCalculator);
        Assert.assertEquals(0.4166666667, geod.averageValue(this.directedNonConnected),0.0001);
        
        geod = new Geodesics<>(uscBetweennessCalculator);
        Assert.assertEquals(1.277777777, geod.averageValue(this.undirectedConnected),0.0001);
        
        geod = new Geodesics<>(uncBetweennessCalculator);
        Assert.assertEquals(0.5, geod.averageValue(this.undirectedNonConnected),0.0001);
    }
