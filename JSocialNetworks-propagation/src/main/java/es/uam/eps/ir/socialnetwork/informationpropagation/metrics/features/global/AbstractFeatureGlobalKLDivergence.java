...
/**
 * This global metric computes the KL divergence of the priori distribution of the parameter
 * values over the whole set of information pieces, and the frequency of receival of
 * these parameters for the set of users.
 * 
 ...
 *          </li>
 *          <li><i>Simulation distribution:</i> In this case, for each received and seen information
 *          piece (by any user), we sum the value of each parameter for the creator of the piece.
 *          </li>
 *      </ul>
 *  </li>
 ...
 */
public abstract class AbstractFeatureGlobalKLDivergence<U extends Serializable,I extends Serializable,P> extends AbstractFeatureGlobalSimulationMetric<U,I,P> 
{
    /**
     * Times each parameter has been received.
     */
    protected final Map<P,Double> qvalues;
     ...
     */
    public AbstractFeatureGlobalKLDivergence(String name, String parameter, boolean userparam, boolean unique) 
    {
    ...
    protected void initialize() 
    {
        if(!this.isInitialized())
        {
            ...
            int aux = data.numFeatureValues(this.getParameter());
