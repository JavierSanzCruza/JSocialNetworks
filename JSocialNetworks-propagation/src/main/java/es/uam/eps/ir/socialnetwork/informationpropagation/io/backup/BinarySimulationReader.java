...
public class BinarySimulationReader<U extends Serializable, I extends Serializable, P> implements SimulationReader<U,I,P>
{
    ...
    public Iteration<U,I,P> readIteration(Data<U,I,P> data)
    {
        ...
        try
        {
            ...
            {
                receptionMap.entrySet().forEach(entry -> iter.addReceivingUser(entry.getKey(), entry.getValue()));
            }
            ...
            {
                receptionMap.entrySet().forEach(entry -> iter.addReReceivingUser(entry.getKey(), entry.getValue()));
            }
            ...
            {
                actionMap.entrySet().forEach(entry -> iter.addPropagatingUser(entry.getKey(), entry.getValue()));
            }
            ...
            {
                actionMap.entrySet().forEach(entry -> iter.addDiscardingUser(entry.getKey(), entry.getValue()));
            }            
