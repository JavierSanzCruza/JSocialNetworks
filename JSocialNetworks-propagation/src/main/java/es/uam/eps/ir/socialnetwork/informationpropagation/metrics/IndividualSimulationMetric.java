...
public interface IndividualSimulationMetric<U extends Serializable,I extends Serializable,P> extends SimulationMetric<U,I,P> 
{
     ...
     */
    public default List<Map<U,Double>> calculateIndividuals(Simulation<U,I,P> simulation)
    {
     ...
     */
    public default List<Double> calculate(U user, Simulation<U,I,P> simulation)
    {
