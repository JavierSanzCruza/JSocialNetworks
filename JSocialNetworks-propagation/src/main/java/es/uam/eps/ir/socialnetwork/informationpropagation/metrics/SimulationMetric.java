...
{    
     ...
     */
    public default List<Double> calculate(Data<U,I,P> data, Simulation<U,I,P> simulation)
    {
     ...
     */
    public default void initialize(Data<U,I,P> data, Simulation<U,I,P> backupSim)
    {
        this.initialize(data);
